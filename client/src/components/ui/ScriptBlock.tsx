...
/** Roteiro de apresentação em vídeo — itálico pra diferenciar do resto da
 * UI, já que é um texto pensado pra ser falado. */
  ...
  return (
    <div className="mt-4 rounded-r-lg border-l-[3px] border-accent bg-accent-soft py-4 pl-4.5 pr-4">
      <div className="mb-2.5 flex items-center justify-between gap-2.5">
        <h4 className="font-body text-[13px] font-bold uppercase tracking-wide text-accent-dark">
          Texto de apresentação (vídeo)
        </h4>
        <button
          type="button"
          onClick={copy}
