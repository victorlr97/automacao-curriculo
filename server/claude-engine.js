...
5. "objective" (o "Sobre" do currículo): escreva um parágrafo NOVO de abertura de perfil profissional. Comece pela identidade de ${name} em construção nominal/impessoal — cargo/área + tempo ou nível de experiência (ex: "Desenvolvedor Full Stack com X anos de experiência em Y" / "Full Stack Developer with X years of experience in Y") — nunca por uma frase de intenção tipo "Busca uma posição onde..." (isso é objetivo de carreira clássico, evite) nem por uma lista de ferramentas/competências reformulada em prosa (isso é resumo de skills, também evite — ex: "Fluent in AI-first workflows: Claude Code is part of the daily process for X, Y, and Z" cai nessa armadilha). Depois da abertura, conecte essa identidade a no máximo 1-2 fatos concretos de background_facts (não uma varredura de todos os 5) com uma característica real dessa vaga específica — não apenas "sei usar as ferramentas que a vaga pede". Ecoe 2-3 palavras-chave literais da vaga. Máximo 3-4 frases curtas.
